...
<body>
  <div class="con container">
   ...
   <div class="page-header">
    ...
    <br><br>
    <form role="form" action="formularios21.php" method="post">
...
while ( $vector = $resultado->fetchArray() ) {
    ...
    echo "<tr>";
    echo "<td><input type='text' name='autor' value='" .$vector[1]. "'></td>";
    echo "<td><button type='submit' class='btn btn-default'>" .$vector[1]. "</button></td>";
    echo "<td>" .$vector[2]. "</td>";
    echo "<td>" .$vector[3]. "</td>";
    echo "<td>" .$vector[4]. "</td>";
    echo "<td>" .$vector[5]. "</td>";
...
?>
    ...
    <button type="button" class="btn btn-default" OnClick="abre('https://www.barelpasaje.com')">Prueba</button>
