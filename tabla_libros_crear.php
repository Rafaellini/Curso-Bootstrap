...
$db->query( "DROP TABLE libros" );
$l  = " CREATE TABLE libros (          ";
$l .= "	ID_LIBROS INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL ,	";
$l .= " TITULO     	  VARCHAR NOT NULL ,  	";
$l .= " SUBTITULO     VARCHAR ,             "; 
$l .= " AUTOR_NOMBRE        VARCHAR NOT NULL ,    "; 
$l .= " AUTOR_APELLIDOS     VARCHAR NOT NULL ,    "; 
$l .= " SERIE  			  VARCHAR ,           	"; 
$l .= " N_SERIE  	    NUMBER ,            	";
$l .= " EDITORIAL  	  VARCHAR ,             ";
$l .= " SEDE  		    VARCHAR ,             "; //De la editorial
$l .= " FECHA         NUMBER       "; //De la edición
...
$db->query( " INSERT INTO libros VALUES(NULL, 'Ready Player One', NULL,'Ernest', 'Cline', NULL, NULL,'Penguin Random House', 'Barcelona', 2018)       	");
$db->query( " INSERT INTO libros VALUES(NULL, '¿Sueñan los androides con ovejas eléctricas?', 'Blade Runner', 'Philip K.', 'Dick', NULL, NULL, 'Minotauro', 'Barcelona', 2017)  ");
$db->query( " INSERT INTO libros VALUES(NULL, 'El hombre en El Castillo', NULL, 'Philip K.', 'Dick', NULL, NULL, 'Minotauro', 'Barcelona', NULL)  ");
$db->query( " INSERT INTO libros VALUES(NULL, 'La plata de Britania',NULL, 'Lindsey', 'Davis', 'Marco Didio Falco', 1, 'Edhasa', 'Barcelona', NULL)       		");
$db->query( " INSERT INTO libros VALUES(NULL, 'La estatua de bronce',NULL, 'Lindsey', 'Davis', 'Marco Didio Falco', 2, 'Edhasa', 'Barcelona', NULL)           ");
$db->query( " INSERT INTO libros VALUES(NULL, 'La Venus de cobre',NULL, 'Lindsey', 'Davis', 'Marco Didio Falco', 3, 'Edhasa', 'Barcelona', NULL)           ");
$db->query( " INSERT INTO libros VALUES(NULL, 'La solterona', NULL,'Honoré', 'de Balzac', NULL, NULL, 'Edaf', 'Madrid', 1972)       ");
